          ...
          <div class="container">
            <div class="container text-left">
              ...
              <div class="breadcrumbs_path">
                <a><router-link style="color: #feffff" to="/">Home</router-link></a> > <a><router-link style="color: #feffff" to="/jobs">All Jobs</router-link></a> > {{messagetitle}}
              </div>
            </div>
        </div>
      </div>
